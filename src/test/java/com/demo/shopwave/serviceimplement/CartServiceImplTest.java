...
class CartServiceImplTest {
	...
	void testIncreaseCartQuantity_Negative() {
		...
		assertThrows(ShopwaveApplicationException.class, () -> cartService.increaseCartQuantity(cartDTO));
	}
	...
	void testDecreaseCartQuantity_Negative() {
		...
		assertThrows(ShopwaveApplicationException.class, () -> cartService.decreaseCartQuantity(cartDTO));
	}
	...
	void testDeleteCart_Negative_CustomerLinked() {
		...
		Exception ex = assertThrows(ShopwaveApplicationException.class, () -> cartService.deleteCart(1));
