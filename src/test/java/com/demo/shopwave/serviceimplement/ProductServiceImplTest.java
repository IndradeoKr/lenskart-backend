...
class ProductServiceImplTest {
	...
	@Test
    void testAddProduct_Success() throws ShopwaveApplicationException {
	...
	@Test
    void testUpdateProduct_Success() throws ShopwaveApplicationException {
	...
	@Test
    void testDeleteProduct_Success() throws ShopwaveApplicationException {
	...
	@Test
    void testGetById_Success() throws ShopwaveApplicationException {
        when(productRepository.findById(1)).thenReturn(Optional.of(product));
	...
	@Test
    void testGetProductByBrand_Success() throws ShopwaveApplicationException {
	...
	@Test
    void testFindAll_Success() throws ShopwaveApplicationException {
	...
	void testAddProduct_InvalidData() {
		...
		assertThrows(ShopwaveApplicationException.class, () -> productService.addProduct(productDTO));
	}
	...
	void testUpdateProduct_InvalidId() {
		...
		assertThrows(ShopwaveApplicationException.class, () -> productService.updateProduct(productDTO));
	}
    ...
    void testDeleteProduct_NotFound() {
        ...
        assertThrows(ShopwaveApplicationException.class, () -> productService.deleteProduct(1));
    }

	@Test
    void testGetById_NotFound() {
        when(productRepository.findById(1)).thenReturn(Optional.empty());
        assertThrows(ShopwaveApplicationException.class, () -> productService.getById(1));
    }

	@Test
	void testGetProductByBrand_EmptyName() {
		assertThrows(ShopwaveApplicationException.class, () -> productService.getProductByBrand(""));
	}

	@Test
    void testGetProductByBrand_NotFound() {
        when(productRepository.findByBrand("RayBan")).thenReturn(Collections.emptyList());
        assertThrows(ShopwaveApplicationException.class, () -> productService.getProductByBrand("RayBan"));
    }

	@Test
    void testFindAll_EmptyDatabase() {
        when(productRepository.findAll()).thenReturn(Collections.emptyList());
        assertThrows(ShopwaveApplicationException.class, () -> productService.findAll());
    }
