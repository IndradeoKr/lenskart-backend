...
class CustomerServiceImplTest {
	...
	@Test
	void testRegisterCustomer_SuccessfulAdded() throws ShopwaveApplicationException {
	...
	@Test
	void testRegisterCustomer_OnlyOneCustomerAllowed() throws ShopwaveApplicationException {
		List<User> listOfUsers = new ArrayList<>();
	...
	@Test
	void testUpdateCustomerName_SuccessfulUpdate() throws ShopwaveApplicationException
	{
	...
	@Test
    void testUpdateCustomerName_AdminNotFound() throws ShopwaveApplicationException{
	...
	@Test 
	void testUpdateCustomerName_WrongPassword() throws ShopwaveApplicationException{
        when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
	...
	@Test
	void testUpdateCustomerName_UserIsNotAdmin() throws ShopwaveApplicationException {
		user.setRole("ADMIN");
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
	...
	@Test
	void testUpdateCustomer_SuccefulUpdate() throws ShopwaveApplicationException
	{
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
	...
	@Test
	void testUpdateCustomer_AdminNotFound() throws ShopwaveApplicationException
	{
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(null);
		ShopwaveApplicationException ex=assertThrows(
			ShopwaveApplicationException.class,
	...
	@Test
	void testUpdateCustomer_WrongPassword() throws ShopwaveApplicationException
	{
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
		ShopwaveApplicationException ex=assertThrows(
			ShopwaveApplicationException.class,
	...
	@Test
	void testUpdateCustomer_UserIsNotAdmin() throws ShopwaveApplicationException {
		user.setRole("ADMIN");
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
		ShopwaveApplicationException ex = assertThrows(ShopwaveApplicationException.class,
				() -> customerService.updateCustomer("abc@gmail.com", "000000", userDTO));
	...
	@Test
	void testGetByEmail_successfulGet() throws ShopwaveApplicationException {
	...
	@Test
	void testGetByEmail_AdminNotFound() throws ShopwaveApplicationException {
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(null);
		ShopwaveApplicationException ex=assertThrows(ShopwaveApplicationException.class,
	...
	@Test
	void testGetByEmail_UserIsNotCustomer() throws ShopwaveApplicationException {
		user.setRole("ADMIN");
		when(userRepository.findByEmail("abc@gmail.com")).thenReturn(user);
		ShopwaveApplicationException ex = assertThrows(ShopwaveApplicationException.class,
				() -> customerService.getByEmail("abc@gmail.com"));
	...
	@Test
	void testDeleteCustomer_SuccessfulDelete() throws ShopwaveApplicationException {
	...
	@Test
	void testDeleteCustomer_CustomerNotFound() throws ShopwaveApplicationException {
	...
	@Test
	void testDeleteCustomer_UserIsNotCustomer() throws ShopwaveApplicationException {
		user.setRole("Admin");
		when(userRepository.findById(1)).thenReturn(Optional.of(user));
		ShopwaveApplicationException ex = assertThrows(ShopwaveApplicationException.class,
				() -> customerService.deleteCustomer(1));
