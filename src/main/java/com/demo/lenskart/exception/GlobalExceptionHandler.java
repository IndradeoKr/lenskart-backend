package com.demo.lenskart.exception;
...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(LenskartApplicationException.class)
	public ResponseEntity<String> handleEmployeeNotFoundException(LenskartApplicationException exc) {
