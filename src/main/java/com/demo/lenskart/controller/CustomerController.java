...
public class CustomerController {
	...
	@DeleteMapping
	public ResponseEntity<String> deleteCustomer(@RequestParam int id) throws LenskartApplicationException {
	...
	public ResponseEntity<UserDTO> getCustomerByEmail(
			@RequestParam @Email(message = "Invalid email format") String email) throws LenskartApplicationException {
	...
	@GetMapping("/all")
	public ResponseEntity<java.util.List<UserDTO>> getAllCustomers() throws LenskartApplicationException {
