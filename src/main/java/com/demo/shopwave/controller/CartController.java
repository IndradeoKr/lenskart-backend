...
public class CartController {
	...
	@PostMapping
	public ResponseEntity<String> addToCart(@RequestBody @Valid CartDTO cartDTO) throws ShopwaveApplicationException {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<String> removeCart(@PathVariable int id) throws ShopwaveApplicationException {
	...
	public ResponseEntity<CartViewDTO> getCartForCustomer(@PathVariable int customerId) throws ShopwaveApplicationException {
