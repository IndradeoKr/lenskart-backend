...
public class AdminController {
	...
	public ResponseEntity<String> addAdmin(@Valid @RequestBody UserDTO adminDTO) throws ShopwaveApplicationException {
	...
	public ResponseEntity<List<UserDTO>> getAllAdmins() throws ShopwaveApplicationException {
	...
	public ResponseEntity<String> updateAdminName(@RequestParam @Email(message = "Invalid email format") String email,
			...
			@RequestParam @NotBlank(message = "Name cannot be blank") String name) throws ShopwaveApplicationException {
	...
	public ResponseEntity<String> deleteAdminById(@RequestParam int adminId) throws ShopwaveApplicationException {
