...
public class CustomerServiceImpl implements ICustomerService {
	...
	public String registerCustomer(UserDTO customerDTO) throws ShopwaveApplicationException {
		...
		// 				user.getUserid());
		// 		throw new ShopwaveApplicationException("Only one customer is allowed");
		// 	}
		// }
	...
	public String updateCustomer(String email, String password, UserDTO customerDTO) {
		...
		if (user == null) {
			...
			throw new ShopwaveApplicationException("Customer with email " + email + " not found.");
		}
		...
		if (!(passwordEncoder.matches(password, user.getPassword()) || user.getPassword().equals(password))) {
			...
			throw new ShopwaveApplicationException("Customer with email " + email + " Wrong Password.");
		}
		...
		if (!CUSTOMER_ROLE.equalsIgnoreCase(user.getRole())) {
			...
			throw new ShopwaveApplicationException("User with email " + email + " is not a customer.");
		}
	...
	public String deleteCustomer(int userId) throws ShopwaveApplicationException {
		...
		if (user == null) {
			...
			throw new ShopwaveApplicationException("Customer with ID " + userId + " not found.");
		}
		...
		if (!CUSTOMER_ROLE.equalsIgnoreCase(user.getRole())) {
			...
			throw new ShopwaveApplicationException("User with email " + user.getEmail() + " is not a customer.");
		}
	...
	@Override
	public List<UserDTO> getAllCustomers() throws ShopwaveApplicationException {
